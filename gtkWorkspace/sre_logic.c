...
void state_update()
{
    ...
    sre_temperatures->temp_motor_fl = GW_PE_FrontLeft.TempMotor;
    sre_temperatures->temp_motor_fr = GW_PE_FrontRight.TempMotor;
    sre_temperatures->temp_motor_rl = GW_PE_RearLeft.TempMotor;
    sre_temperatures->temp_motor_rr = GW_PE_RearRight.TempMotor;

    // BATTERY
    sre_battery->bat_soc = GW_Battery_Status.SOC_Internal;
    sre_battery->bat_temp_max = GW_Battery_Cells.TempMax;
    sre_battery->bat_temp_min = GW_Battery_Cells.TempMin;
