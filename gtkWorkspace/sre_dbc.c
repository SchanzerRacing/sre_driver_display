...
void LOG_FUSE_Currents_UnionToStruct(struct LOG_FUSE_Currents_Struct *s,
                                            union LOG_FUSE_Currents_Union u) {
  s->epos_current = (uint16_t)u.epos_current;
  s->sdc_current = (uint16_t)u.sdc_current;
}

void LOG_FUSE_Currents_StructToUnion(union LOG_FUSE_Currents_Union *u,
...
void PARC_FUSE_States_UnionToStruct(struct PARC_FUSE_States_Struct *s,
...
void PARC_FUSE_States_StructToUnion(union PARC_FUSE_States_Union *u,
...
void PARS_FUSE_States_UnionToStruct(struct PARS_FUSE_States_Struct *s,
...
void PARS_FUSE_States_StructToUnion(union PARS_FUSE_States_Union *u,
...
void LOG_SBG_ODO_Info_UnionToStruct(struct LOG_SBG_ODO_Info_Struct *s,
...
void LOG_SBG_ODO_Info_StructToUnion(union LOG_SBG_ODO_Info_Union *u,
...
void LOG_SBG_EKF_Info_UnionToStruct(struct LOG_SBG_EKF_Info_Struct *s,
                                           union LOG_SBG_EKF_Info_Union u) {
  s->time_stamp = (uint32_t)u.time_stamp;
}

void LOG_SBG_EKF_Info_StructToUnion(union LOG_SBG_EKF_Info_Union *u,
...
void LOG_SBG_POS_Info_UnionToStruct(struct LOG_SBG_POS_Info_Struct *s,
                                           union LOG_SBG_POS_Info_Union u) {
  s->time_stamp = (uint32_t)u.time_stamp;
}

void LOG_SBG_POS_Info_StructToUnion(union LOG_SBG_POS_Info_Union *u,
...
void LOG_SBG_Status_03_UnionToStruct(struct LOG_SBG_Status_03_Struct *s,
                                            union LOG_SBG_Status_03_Union u) {}

void LOG_SBG_Status_03_StructToUnion(union LOG_SBG_Status_03_Union *u,
                                            struct LOG_SBG_Status_03_Struct s) {
}

/* --------------------------- LOG_SBG_Status_02 --------------------------- */

void LOG_SBG_Status_02_UnionToStruct(struct LOG_SBG_Status_02_Struct *s,
...
void LOG_SBG_Status_02_StructToUnion(union LOG_SBG_Status_02_Union *u,
...
void LOG_SBG_Status_01_UnionToStruct(struct LOG_SBG_Status_01_Struct *s,
...
void LOG_SBG_Status_01_StructToUnion(union LOG_SBG_Status_01_Union *u,
...
void GW_Battery_Cells_UnionToStruct(struct GW_Battery_Cells_Struct *s,
...
void GW_PE_FrontLeft_StructToUnion(union GW_PE_FrontLeft_Union *u,
...
void GW_PE_RearRight_StructToUnion(union GW_PE_RearRight_Union *u,
...
void GW_PE_FrontRight_StructToUnion(union GW_PE_FrontRight_Union *u,
...
void EXC_FAN_Control_UnionToStruct(struct EXC_FAN_Control_Struct *s,
                                          union EXC_FAN_Control_Union u) {
  s->fan_request = (uint8_t)u.fan_request;
  s->fan_on = (bool)u.fan_on;
}

void EXC_FAN_Control_StructToUnion(union EXC_FAN_Control_Union *u,
...
void EXC_PUMP_Control_UnionToStruct(struct EXC_PUMP_Control_Struct *s,
                                           union EXC_PUMP_Control_Union u) {
  s->pump_request = (uint8_t)u.pump_request;
  s->pump_on = (bool)u.pump_on;
}

void EXC_PUMP_Control_StructToUnion(union EXC_PUMP_Control_Union *u,
...
void LSC_Dash_Buttons_UnionToStruct(struct LSC_Dash_Buttons_Struct *s,
...
void LSC_Dash_Buttons_StructToUnion(union LSC_Dash_Buttons_Union *u,
...
void SAF_DASH_Status_UnionToStruct(struct SAF_DASH_Status_Struct *s,
...
void SAF_DASH_Status_StructToUnion(union SAF_DASH_Status_Union *u,
...
void HSC_DriverInput_StructToUnion(union HSC_DriverInput_Union *u,
...
void CANO_RES_NMT_EC_UnionToStruct(struct CANO_RES_NMT_EC_Struct *s,
                                          union CANO_RES_NMT_EC_Union u) {}

void CANO_RES_NMT_EC_StructToUnion(union CANO_RES_NMT_EC_Union *u,
...
void DV_FREE_TO_USE_2_UnionToStruct(struct DV_FREE_TO_USE_2_Struct *s,
                                           union DV_FREE_TO_USE_2_Union u) {}

void DV_FREE_TO_USE_2_StructToUnion(union DV_FREE_TO_USE_2_Union *u,
...
void DV_System_Status_UnionToStruct(struct DV_System_Status_Struct *s,
...
void DV_System_Status_StructToUnion(union DV_System_Status_Union *u,
...
void CAL_SteeringAngle_UnionToStruct(struct CAL_SteeringAngle_Struct *s,
                                            union CAL_SteeringAngle_Union u) {
  s->voltage = (uint16_t)u.voltage;
}

void CAL_SteeringAngle_StructToUnion(union CAL_SteeringAngle_Union *u,
...
void DV_DriveCommand_UnionToStruct(struct DV_DriveCommand_Struct *s,
...
void DV_DriveCommand_StructToUnion(union DV_DriveCommand_Union *u,
