...
SOFT_INLINE void LOG_aero_SPR_StructToUnion(union LOG_aero_SPR_Union *u,
  ...
  u->temp1 = (uint64_t)(s.temp1 * 20.0f);
  u->temp2 = (uint64_t)(s.temp2 * 20.0f);
  u->temp3 = (uint64_t)(s.temp3 * 20.0f);
  u->hum1 = (uint64_t)(s.hum1 * 10.0f);
  u->hum2 = (uint64_t)(s.hum2 * 10.0f);
  u->hum3 = (uint64_t)(s.hum3 * 10.0f);
}
...
LOG_FUSE_Currents_UnionToStruct(struct LOG_FUSE_Currents_Struct *s,
  ...
  s->sdc_current = (uint16_t)u.sdc_current + -3000;
}
...
LOG_FUSE_Currents_StructToUnion(union LOG_FUSE_Currents_Union *u,
  ...
  u->sdc_current = (uint64_t)s.sdc_current - -3000;
}
...
SOFT_INLINE void LOG_Odometry_StructToUnion(union LOG_Odometry_Union *u,
  ...
  u->rear_average_tire_speed = (uint64_t)(s.rear_average_tire_speed * 1000.0f);
}
...
SOFT_INLINE void HSC_SBG_Euler_StructToUnion(union HSC_SBG_Euler_Union *u,
  ...
  u->roll = (uint64_t)(s.roll * 10000.0f);
  u->pitch = (uint64_t)(s.pitch * 10000.0f);
  u->yaw = (uint64_t)(s.yaw * 10000.0f);
}
...
LOG_SBG_IMU_Info_StructToUnion(union LOG_SBG_IMU_Info_Union *u,
  ...
  u->time_stamp = (uint64_t)s.time_stamp;
  u->temperature = (uint64_t)(s.temperature * 100.0f);
}
...
SOFT_INLINE void LOG_SlipRatio_StructToUnion(union LOG_SlipRatio_Union *u,
  ...
  u->slip_ratio_fl = (uint64_t)(s.slip_ratio_fl * 100.0f);
  u->slip_ratio_fr = (uint64_t)(s.slip_ratio_fr * 100.0f);
  u->slip_ratio_rl = (uint64_t)(s.slip_ratio_rl * 100.0f);
  u->slip_ratio_rr = (uint64_t)(s.slip_ratio_rr * 100.0f);
}
...
SOFT_INLINE void LOG_TV_request_StructToUnion(union LOG_TV_request_Union *u,
  ...
  u->tv_fl = (uint64_t)(s.tv_fl * 5.0f);
  u->tv_fr = (uint64_t)(s.tv_fr * 5.0f);
  u->tv_rr = (uint64_t)(s.tv_rr * 5.0f);
  u->tv_rl = (uint64_t)(s.tv_rl * 5.0f);
}
...
SOFT_INLINE void LOG_SlipAngle_StructToUnion(union LOG_SlipAngle_Union *u,
  ...
  u->slip_angle_fl = (uint64_t)(s.slip_angle_fl * 100.0f);
  u->slip_angle_fr = (uint64_t)(s.slip_angle_fr * 100.0f);
  u->slip_angle_rl = (uint64_t)(s.slip_angle_rl * 100.0f);
  u->slip_angle_rr = (uint64_t)(s.slip_angle_rr * 100.0f);
}
...
HSC_SBG_True_Heading_StructToUnion(union HSC_SBG_True_Heading_Union *u,
  ...
  u->pitch = (uint64_t)(s.pitch * 100.0f);
}
...
HSC_SBG_Altitude_StructToUnion(union HSC_SBG_Altitude_Union *u,
  ...
  u->altitude = (uint64_t)(s.altitude * 1000.0f);
  u->undulation = (uint64_t)(s.undulation * 200.0f);
}
...
HSC_SBG_Position_StructToUnion(union HSC_SBG_Position_Union *u,
  ...
  u->latitude = (uint64_t)(s.latitude * 10000000.0f);
  u->longitude = (uint64_t)(s.longitude * 10000000.0f);
}
...
SOFT_INLINE void HSC_SBG_Track_Slip_Curve_StructToUnion(
    union HSC_SBG_Track_Slip_Curve_Union *u,
    struct HSC_SBG_Track_Slip_Curve_Struct s) {
  u->angle_track = (uint64_t)(s.angle_track * 10000.0f);
  u->angle_slip = (uint64_t)(s.angle_slip * 10000.0f);
...
HSC_SBG_EKF_Vel_Body_StructToUnion(union HSC_SBG_EKF_Vel_Body_Union *u,
  ...
  u->velocity_x = (uint64_t)(s.velocity_x * 100.0f);
  u->velocity_y = (uint64_t)(s.velocity_y * 100.0f);
  u->velocity_z = (uint64_t)(s.velocity_z * 100.0f);
}
...
SOFT_INLINE void HSC_SBG_Gyro_StructToUnion(union HSC_SBG_Gyro_Union *u,
  ...
  u->gyro_x = (uint64_t)(s.gyro_x * 1000.0f);
  u->gyro_y = (uint64_t)(s.gyro_y * 1000.0f);
  u->gyro_z = (uint64_t)(s.gyro_z * 1000.0f);
}
...
SOFT_INLINE void HSC_SBG_Accel_StructToUnion(union HSC_SBG_Accel_Union *u,
  ...
  u->accel_x = (uint64_t)(s.accel_x * 100.0f);
  u->accel_y = (uint64_t)(s.accel_y * 100.0f);
  u->accel_z = (uint64_t)(s.accel_z * 100.0f);
}
...
GW_Battery_Status_StructToUnion(union GW_Battery_Status_Union *u,
  ...
  u->current = (uint64_t)(s.current * 10.0f);
}
...
GW_PE_FrontLeft_StructToUnion(union GW_PE_FrontLeft_Union *u,
  ...
  u->temp_motor = (uint64_t)(s.temp_motor * 10.0f);
  u->temp_inverter = (uint64_t)(s.temp_inverter * 10.0f);
  u->tempigbt = (uint64_t)(s.tempigbt * 10.0f);
...
HSC_Vehicle_Status_StructToUnion(union HSC_Vehicle_Status_Union *u,
  ...
  u->velocity_ms = (uint64_t)(s.velocity_ms * 1000.0f);
}
...
SOFT_INLINE void HSC_Steering_StructToUnion(union HSC_Steering_Union *u,
  ...
  u->steering_wheel_angle =
      (uint64_t)(s.steering_wheel_angle * 13.333333333333334f);
  u->steering_angle = (uint64_t)(s.steering_angle * 13.333333333333334f);
...
DV_ASB_Pressure_StructToUnion(union DV_ASB_Pressure_Union *u,
  ...
  u->pressure1 = (uint64_t)(s.pressure1 * 0.25f);
  u->pressure2 = (uint64_t)(s.pressure2 * 0.25f);
}
...
DV_DrivingDynamics1_StructToUnion(union DV_DrivingDynamics1_Union *u,
  ...
  u->steering_angle_actual = (uint64_t)(s.steering_angle_actual * 2.0f);
  u->steering_angle_target = (uint64_t)(s.steering_angle_target * 2.0f);
...
DV_DrivingDynamics2_StructToUnion(union DV_DrivingDynamics2_Union *u,
  ...
  u->acceleration_longitudinal =
      (uint64_t)(s.acceleration_longitudinal * 512.0f);
  u->acceleration_lateral = (uint64_t)(s.acceleration_lateral * 512.0f);
  u->yaw_rate = (uint64_t)(s.yaw_rate * 128.0f);
}
...
CAL_SpringTravel_Rear_StructToUnion(union CAL_SpringTravel_Rear_Union *u,
  ...
  u->rear_right_converted = (uint64_t)(s.rear_right_converted * 100.0f) - 195;
  u->rear_left_converted = (uint64_t)(s.rear_left_converted * 100.0f) - 195;
...
CAL_SpringTravel_Front_StructToUnion(union CAL_SpringTravel_Front_Union *u,
  ...
  u->front_right_converted = (uint64_t)(s.front_right_converted * 100.0f) - 195;
  u->front_left_converted = (uint64_t)(s.front_left_converted * 100.0f) - 195;
...
LOG_SpringTravel_Front_StructToUnion(union LOG_SpringTravel_Front_Union *u,
  ...
  u->front_left = (uint64_t)(s.front_left * 100.0f);
  u->front_right = (uint64_t)(s.front_right * 100.0f);
}
...
LOG_SpringTravel_Rear_StructToUnion(union LOG_SpringTravel_Rear_Union *u,
  ...
  u->rear_left = (uint64_t)(s.rear_left * 100.0f);
  u->rear_right = (uint64_t)(s.rear_right * 100.0f);
}
...
SOFT_INLINE void LOG_airp_FW_UnionToStruct(struct LOG_airp_FW_Struct *s,
  ...
  s->airp1 = (float)(u.airp1 * 2.0f) + 30000;
  s->airp2 = (float)(u.airp2 * 2.0f) + 30000;
}

SOFT_INLINE void LOG_airp_FW_StructToUnion(union LOG_airp_FW_Union *u,
                                           struct LOG_airp_FW_Struct s) {
  u->airp1 = (uint64_t)(s.airp1 * 0.5f) - 30000;
  u->airp2 = (uint64_t)(s.airp2 * 0.5f) - 30000;
}
...
SOFT_INLINE void LOG_airp_SPL_UnionToStruct(struct LOG_airp_SPL_Struct *s,
  ...
  s->airp1 = (float)(u.airp1 * 2.0f) + 30000;
  s->airp2 = (float)(u.airp2 * 2.0f) + 30000;
  s->airp3 = (float)(u.airp3 * 2.0f) + 30000;
}
...
SOFT_INLINE void LOG_airp_SPL_StructToUnion(union LOG_airp_SPL_Union *u,
  ...
  u->airp1 = (uint64_t)(s.airp1 * 0.5f) - 30000;
  u->airp2 = (uint64_t)(s.airp2 * 0.5f) - 30000;
  u->airp3 = (uint64_t)(s.airp3 * 0.5f) - 30000;
}
...
LOG_EKF_Translation_StructToUnion(union LOG_EKF_Translation_Union *u,
  ...
  u->velocity_vx = (uint64_t)(s.velocity_vx * 500.0f);
  u->velocity_vy = (uint64_t)(s.velocity_vy * 500.0f);
  u->acceleration_ax = (uint64_t)(s.acceleration_ax * 500.0f);
  u->acceleration_ay = (uint64_t)(s.acceleration_ay * 500.0f);
}
...
LOG_EKF_Rotation_StructToUnion(union LOG_EKF_Rotation_Union *u,
  ...
  u->heading_psi = (uint64_t)(s.heading_psi * 3333.3333333333335f);
  u->yaw_rate = (uint64_t)(s.yaw_rate * 5555.555555555556f);
}
